Pod::Spec.new do |s|
  s.name     = 'AFNetworking11S'
  s.version  = '4.0.2'  
  s.license  = 'MIT'
  s.summary  = 'A delightful networking framework for Apple platforms.'
  s.homepage = 'https://github.com/kutayinclr/AFNetworking'
  s.social_media_url = 'https://twitter.com/AFNetworking'
  s.authors  = { 'Kutay Inceler' => 's.kutayinceler@gmail.com' }
  s.source   = { :git => 'https://github.com/kutayinclr/AFNetworking', :tag => s.version }
